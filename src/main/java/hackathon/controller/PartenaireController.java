...
public class PartenaireController {
	...
	public String list( Paging paging, Model model ) {
		...
		return "partenaire/list.html";
	}

	@PostMapping( "/list/content" )
	public String buildListContent( Paging paging, Model model ) {
		var page = partenaireService.getPage( paging );
		model.addAttribute( "list", page.getContent() );
		return "partenaire/list.html :: #async_content";
	}
	...
	public String edit( Long id, Model model ) {
		Partenaire item = ( id == null ) ? new Partenaire() : partenaireService.findById( id );
